...
in {
  ...
  users.users.${username} = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAICp00GP8aMaxCWgvthbDcqHMWcAwEwzgOcoatLqqaThdAAAAC3NzaDpwcmltYXJ5 phx-yk-red"
      "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIKOf6dQuq5reydB8gcuHIGWY3TP1MlSCyL0JELuvu9gwAAAAC3NzaDpwcmltYXJ5 phx-yk-blue"
    ];
  };
}
