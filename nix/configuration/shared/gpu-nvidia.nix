...

{
  ...
  hardware.nvidia = {
    ...
    package = config.boot.kernelPackages.nvidiaPackages.mkDriver { # see https://github.com/NixOS/nixpkgs/blob/master/pkgs/os-specific/linux/nvidia-x11/default.nix
      version = "555.58.02";
